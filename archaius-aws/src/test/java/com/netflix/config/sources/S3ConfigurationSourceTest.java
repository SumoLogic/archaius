...
public class S3ConfigurationSourceTest {
  ...
  public void setup() throws Exception {
    ...
    client = S3Client.builder().credentialsProvider(AnonymousCredentialsProvider.create()).forcePathStyle(true).region(Region.US_EAST_1)
      .endpointOverride(new URI("http://localhost:8069")).build();
  }
