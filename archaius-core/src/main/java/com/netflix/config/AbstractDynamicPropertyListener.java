...
/**
 * An abstract {@link PropertyListener} for use by different components who need to listen for configuration changes. Users only need to implement the
 * {@link #handlePropertyEvent(String, Object, EventType)} method.
 * 
 * @author pkamath
 */
public abstract class AbstractDynamicPropertyListener implements PropertyListener {
  ...
  public abstract void handlePropertyEvent(String name, Object value, EventType eventType);
