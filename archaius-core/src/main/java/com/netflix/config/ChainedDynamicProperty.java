...
/**
 * The class that provides the chaining functionality of dynamic properties. The idea is that the head property holds the current up-to-date value of the
 * property and the "next" property in the chain serves as the default if the head property value does not exist or is not acceptable. Concrete implementation
