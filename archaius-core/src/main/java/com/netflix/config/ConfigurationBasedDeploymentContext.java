...
/**
 * An implementation of {@link DeploymentContext} based on system wide configuration set with {@link ConfigurationManager}. All the getters will first consult
 * corresponding property and return the value if set.
 *
 * @author awang
 */
public class ConfigurationBasedDeploymentContext extends SimpleDeploymentContext {
  ...
  private ConfigurationListener configListener = new ConfigurationListener() {
    ...
    public void configurationChanged(ConfigurationEvent event) {
      if (event.isBeforeUpdate()
        || (event.getType() != AbstractConfiguration.EVENT_ADD_PROPERTY && event.getType() != AbstractConfiguration.EVENT_SET_PROPERTY)) {
        return;
      }
  ...
  /**
   * Get the deployment environment. If property "archaius.deployment.environment" is set in the system wide configuration, it will return it. Otherwise, it
   * will return super.getDeploymentEnvironment().
   */
  @Override
  ...
  /**
   * Get the deployment environment. If property "archaius.deployment.datacenter" is set in the system wide configuration, it will return it. Otherwise, it will
  ...
  /**
   * Get the deployment environment. If property "archaius.deployment.applicationId" is set in the system wide configuration, it will return it. Otherwise, it
   * will return super.getApplicationId().
   */
  @Override
  ...
  /**
   * Get the deployment environment. If property "archaius.deployment.serverId" is set in the system wide configuration, it will return it. Otherwise, it will
  ...
  /**
   * Get the deployment environment. If property "archaius.deployment.stack" is set in the system wide configuration, it will return it. Otherwise, it will
  ...
  /**
   * Get the deployment environment. If property "archaius.deployment.region" is set in the system wide configuration, it will return it. Otherwise, it will
