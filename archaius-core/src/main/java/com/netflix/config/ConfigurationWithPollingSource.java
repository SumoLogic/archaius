...
/**
 * This class delegates property read/write to an another configuration but is also attached with a dynamic configuration source and polling scheduler so that
 * its properties can be changed dynamically at runtime. In other words, if the same property is defined in both the original configuration and the dynamic
 * configuration source, the value in the original configuration will be overridden.
 * <p>
...
public class ConfigurationWithPollingSource implements Configuration {
   ...
   * @param source
   *          {@link PolledConfigurationSource} to poll get new/changed properties
   * @param scheduler
   *          AbstractPollingScheduler to provide the polling schedule
   */
