...
/**
 * The default predicate (used by {@link DynamicContextualProperty}) which takes a Function to get the value of key included in the JSON blob as the input
 * string value of {@link DynamicContextualProperty}.
 * 
 * @author awang
 *
 */
