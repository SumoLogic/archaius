...
/**
 * A property that has multiple possible values associated with it and determines the value according to the runtime context, which can include deployment
 * context, values of other properties or attributes of user input.
 * <p>
 ...
 * 
 * <li>If "@enviornment" is "prod" <b>and</b> "@region" is "us-east-1", value of the property is integer 5; (<b>Note:</b> if you use ConfigurationManager,
 * "@enviornment" and "@region" are automatically exported as properties from DeploymentContext)
 * <li>Else if "@environment" is either "test" or "dev", the value is 10;
 * <li>Otherwise, the default value of the property is 2
 * <p>
 * In order to make this work, a Predicate is needed to determine if the current runtime context matches any of the conditions described in the JSON blob. The
 * predicate can be passed in as a parameter of the constructor, otherwise the default one will interpret each key in the "dimensions" as a key of a
 * DynamicProperty, and the list of values are the acceptable values of the DynamicProperty.
 * <p>
 * For example:
 * <p>
 * 
 ...
 *
 * @param <T>
 *          Data type of the property, e.g., Integer, Boolean
 */
