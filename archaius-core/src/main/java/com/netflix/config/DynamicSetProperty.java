...
public abstract class DynamicSetProperty<T> implements Property<Set<T>> {
   ...
   * <code>Splitter.onPattern(delimiterRegex).omitEmptyStrings().trimResults()</code>. The default set value will be transformed from set of strings after
   * splitting. If defaultValue string is null, the default set value will be an empty set.
   */
  ...
  /**
   * Create the dynamic set property. The guava Splitter used is created as <code>Splitter.onPattern(delimiterRegex).omitEmptyStrings().trimResults()</code>.
   * The default set value will be transformed from set of strings after splitting. If defaultValue string is null, the default set value will be an empty set.
   */
  ...
  /**
   * Create the dynamic set property. The guava Splitter used is created as <code>Splitter.onPattern(delimiterRegex).omitEmptyStrings().trimResults()</code>.
   * The default set value will be taken from the passed in set argument.
   */
