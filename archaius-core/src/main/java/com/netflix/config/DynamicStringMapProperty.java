...
public class DynamicStringMapProperty extends DynamicMapProperty<String, String> {
  ...
  public DynamicStringMapProperty(String propName, String defaultValue, String mapEntryDelimiterRegex) {
  ...
  public DynamicStringMapProperty(String propName, Map<String, String> defaultValue, String mapEntryDelimiterRegex) {
    super(propName, defaultValue, mapEntryDelimiterRegex);
  }
