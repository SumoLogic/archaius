 ...
 * 
 * The property values in this configuration will be changed dynamically at runtime if the value changes in the underlying configuration source.
 * <p>
...
public class DynamicWatchedConfiguration extends ConcurrentMapConfiguration implements WatchedUpdateListener {
   ...
   * 
   * @param source
   *          {@link WatchedConfigurationSource}
   */
