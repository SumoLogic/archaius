...
/**
 * <p>
 * An <code>ExpandedConfigurationListenerAdapter</code> wraps an instance of {@link PropertyListener}. When it receives the property modification notification
 * from the Apache Configuration, it translates the {@link ConfigurationEvent} into the corresponding events for {@link PropertyListener}.
 * <p>
 * It also has the capability to pause the event delivery through the {@link #setPauseListener(boolean)} API.
 * <p>
 * This class is used as an adapter to attach a {@link PropertyListener} to a Configuration so that methods in the {@link PropertyListener} will be called when
...
public class ExpandedConfigurationListenerAdapter implements ConfigurationListener {
  ...
  /**
   * <p>
   * Create a new <code>ExpandedConfigurationListenerAdapter</code> that wraps the provided {@link PropertyListener}.
   * </p>
   *
   *
   * @param listener
   ...
   *           if the configuration or listener is <code>null</code>.
   */
