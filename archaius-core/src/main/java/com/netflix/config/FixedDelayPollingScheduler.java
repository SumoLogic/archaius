...
public class FixedDelayPollingScheduler extends AbstractPollingScheduler {
  ...
  /**
   * Create an instance with initial delay and delay defined in system properties {@value #INITIAL_DELAY_PROPERTY} and {@value #DELAY_PROPERTY} The scheduler
   * will delete the property in a configuration if it is absent from the configuration source.
   */
