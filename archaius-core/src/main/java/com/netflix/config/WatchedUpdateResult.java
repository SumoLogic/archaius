...
/**
 * This class represents the result of a callback from the WatchedConfigurationSource. The result may be the complete content of the configuration source - or
 * an incremental one.
 * 
 * @author cfregly
...
public class WatchedUpdateResult {
  ...
  /**
   * Indicate whether this result has any content. If the result is incremental, this is true if there is any any added, changed or deleted properties. If the
   * result is complete, this is true if {@link #getComplete()} is null.
   */
