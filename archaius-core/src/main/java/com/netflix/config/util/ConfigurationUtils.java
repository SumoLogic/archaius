...
public class ConfigurationUtils {
  ...
  /**
   * Gets all named sub-configuration from a configuration in a map. This method examines each sub-configuration which is an instance of
   * {@link ConcurrentCompositeConfiguration} or CombinedConfiguration and extract the named configurations out of them.
   * 
   * @param conf
  ...
  /**
   * Utility method to obtain <code>Properties</code> given an instance of <code>AbstractConfiguration</code>. Returns an empty <code>Properties</code> object
   * if the config has no properties or is null.
   * 
   * @param config
   *          Configuration to get the properties
...
class OverridingPropertiesConfiguration extends PropertiesConfiguration {
  ...
  public OverridingPropertiesConfiguration(String fileName) throws ConfigurationException {
    super(fileName);
  }
