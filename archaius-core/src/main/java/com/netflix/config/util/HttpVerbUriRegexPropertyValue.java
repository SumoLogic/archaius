...
/**
 * There are a few features in platform and allied libraries which need to parse a property of the form &lt;uriRegex&gt; OR &lt;HTTP Verb
 * name&gt;&lt;space&gt;&lt;uriRegex&gt;. This class provides the functionality to represent such a property value including static methods to parse such
 * property values.
 * 
 * @author pkamath
 * 
...
public class HttpVerbUriRegexPropertyValue {
   ...
   * @param propValue
   *          property value
   * @return {@link HttpVerbUriRegexPropertyValue} instance corresponding to propValue if propValue is not null, null otherwise
   */
  ...
  public enum Verb {
    GET("GET"), PUT("PUT"), POST("POST"), DELETE("DELETE"), OPTIONS("OPTIONS"), HEAD("HEAD"), ANY_VERB("ANY"); // catch-all -
                                                                                                               // essentially any
                                                                                                               // verb!
