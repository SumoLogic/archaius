...
/**
 * Simple benchmark impl to compare the caching of primitive boolean value in CachedDynamicBooleanProperty with the original implementation.
 *
 * @author Mike Smith Date: 11/25/15
 */
