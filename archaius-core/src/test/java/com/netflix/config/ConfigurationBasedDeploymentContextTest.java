...
public class ConfigurationBasedDeploymentContextTest {
  ...
  public void testGetAndSetAppId() throws Exception {
    ...
    assertTrue(testPropertyValues(DeploymentContext.ContextKey.appId, ConfigurationBasedDeploymentContext.DEPLOYMENT_APPLICATION_ID_PROPERTY, "appId2"));
  }
  ...
  public void testGetAndSetDatacenter() throws Exception {
    ...
    assertTrue(testPropertyValues(DeploymentContext.ContextKey.datacenter, ConfigurationBasedDeploymentContext.DEPLOYMENT_DATACENTER_PROPERTY, "datacenter2"));
  }
  ...
  public void testGetAndSetEnvironment() throws Exception {
    ...
    assertTrue(
      testPropertyValues(DeploymentContext.ContextKey.environment, ConfigurationBasedDeploymentContext.DEPLOYMENT_ENVIRONMENT_PROPERTY, "environment2"));
  }
  ...
  public void testGetAndSetRegion() throws Exception {
    ...
    assertTrue(testPropertyValues(DeploymentContext.ContextKey.region, ConfigurationBasedDeploymentContext.DEPLOYMENT_REGION_PROPERTY, "region2"));
  }
  ...
  public void testGetAndSetServerId() throws Exception {
    ...
    assertTrue(testPropertyValues(DeploymentContext.ContextKey.serverId, ConfigurationBasedDeploymentContext.DEPLOYMENT_SERVER_ID_PROPERTY, "server2"));
  }
  ...
  public void testGetAndSetStack() throws Exception {
    ...
    assertTrue(testPropertyValues(DeploymentContext.ContextKey.stack, ConfigurationBasedDeploymentContext.DEPLOYMENT_STACK_PROPERTY, "stack2"));
  }

  private boolean testPropertyValues(DeploymentContext.ContextKey key, String deploymentPropName, String expectedValue) {
    return config.getString(key.getKey()).equals(expectedValue) && config.getString(deploymentPropName).equals(expectedValue);
  }
}
