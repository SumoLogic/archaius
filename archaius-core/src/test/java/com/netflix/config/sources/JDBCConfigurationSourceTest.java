...
/**
 * Unit tests for the JDBCConfigurationSource class This class uses the Derby embedded database. In real life one can replace this with RDBMS products like
 * Oracle, MySQL etc.
 * 
 * @author stonse
 *
...
public class JDBCConfigurationSourceTest {
  ...
  public void testSimpleInMemoryJDBCDynamicPropertySource() throws Throwable {
    ...
    try {
      JDBCConfigurationSource source = new JDBCConfigurationSource(ds, "select distinct property_key, property_value from MySiteProperties", "property_key",
        "property_value");
